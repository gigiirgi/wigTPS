...
<html>
	<head>
		...
		var txt=" Halaman Update Data [Software WIG TPS] ";
		var speed=250;
		var refresh=null;
...
<body>
	...
	<div class="wrap">
		<div class="header">
			<header><b>Form Perbarui Data</b></header>
		</div>		
		
	<div class="body">
		<center>
		<form method = 'POST' action = 'eksekusi/perbarui.php'>
			<table>
				<tr class="">
				...
				<tr>
					<th align="left">LM1 : Pemutusan</th>
						<td> Target	<input name="t_pemutusan"></td>
						<td> Realisasi <input name="r_pemutusan"></td>
				</tr>
				<tr>
					<th align="left">LM2 : Bongkar Rampung</th>
						<td> Target	<input name="t_bongkar"></td>
						<td> Realisasi <input name="r_bongkar"></td>
				</tr>
				<tr>
					<th align="left">LM3 : Somasi</th>
						<td> Target	<input name="t_somasi"></td>
						<td> Realisasi <input name="r_somasi"></td>
				</tr>
				<tr>
					<th align="left">Keterangan Petugas</th>
						<td>Tusbung Mandiri: <input name="petugas"></td>
						<td>Tim Bongkar: <input name="tim"></td>
				</tr>
				<tr>
					<td align="center" colspan="3" >
						<input onclick="return confirm('Apakah Data Sudah Benar?')" type="submit" name="submit" value="Update Data">	
